...
interface FormatQueryOptions {
  format?: 'sql' | 'json' | 'json_without_ids' | 'parameterized'; | 'parameterized_named' // same as passing a `format` string instead of an options object
