...
import { datetimeRuleProcessor } from './datetimeRuleProcessor';

export const formatQueryDateTime = (query: RuleGroupType, options: FormatQueryOptions): string =>
  formatQuery(query, { ...options, ruleProcessor: datetimeRuleProcessor });
...
export const CREATE_MUSICIANS_TABLE = (platform: string): string => {
