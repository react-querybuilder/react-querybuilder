 ...
 */
export type ToRuleGroupTypeIC<T extends RuleGroupTypeAny> = T extends RuleGroupTypeIC
  ? T
 ...
 */
export type ToRuleGroupType<T extends RuleGroupTypeAny> = T extends { combinator: string }
  ? T
