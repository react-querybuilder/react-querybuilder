...
const query: RuleGroupType = {
  ...
  rules: [
    ...
    { id: '333', disabled: true, field: 'firstName', value: 'Test', operator: '=' },
    {
      disabled: true,
      combinator: 'and',
      id: '444',
...
const queryDeepDisabled: RuleGroupType = {
  combinator: 'and',
  id: '111',
  rules: [
    { id: '222', field: 'firstName', value: 'Test', operator: '=' },
    {
      ...
      id: '333',
      rules: [
        { id: '444', field: 'firstName', value: 'Test', operator: '=' },
        { id: '555', disabled: true, field: 'firstName', value: 'Test', operator: '=' },
      ],
    },
  ],
};

const queryDeepDisabled2: RuleGroupType = {
  combinator: 'and',
  id: '111',
  rules: [
    { id: '222', field: 'firstName', value: 'Test', operator: '=' },
