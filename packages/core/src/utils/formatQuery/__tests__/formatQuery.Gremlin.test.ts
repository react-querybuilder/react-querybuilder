...
const gremlinString = `.hasNot('firstName').has('lastName').has('firstName', within('Test', 'This')).has('lastName', without('Test', 'This')).has('firstName', between('Test', 'This')).has('firstName', between('Test', 'This')).has('lastName', outside('Test', 'This')).has('age', between('12', '14')).has('age', '26').has('isMusician', true).has('isLucky', false).not(__.or(__.has('gender', 'M'), __.has('job', neq('Programmer')), __.has('email', containing('@')))).or(__.has('lastName', notContaining('ab')), __.has('job', startingWith('Prog')), __.has('email', endingWith('com')), __.has('job', notStartingWith('Man')), __.has('email', notEndingWith('fr'))).has('invalid', '')`;
const gremlinStringForValueSourceField = `.hasNot('firstName').has('lastName').has('firstName', within(middleName, lastName)).has('lastName', without(middleName, lastName)).has('firstName', between(middleName, lastName)).has('firstName', between(middleName, lastName)).has('lastName', outside(middleName, lastName)).has('age', iq).has('isMusician', isCreative).not(__.or(__.has('gender', someLetter), __.has('job', neq(isBetweenJobs)), __.has('email', containing(atSign)))).or(__.has('lastName', notContaining(firstName)), __.has('job', startingWith(jobPrefix)), __.has('email', endingWith(dotCom)), __.has('job', notStartingWith(hasNoJob)), __.has('email', notEndingWith(isInvalid)))`;
