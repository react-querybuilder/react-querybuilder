...
const celStringForMatchModes =
  'fs.all(elem_alias, elem_alias.contains("S")) && fs.all(elem_alias, elem_alias.fv.contains("S")) && !fs.exists(elem_alias, elem_alias.contains("S")) && fs.exists(elem_alias, elem_alias.contains("S")) && fs.exists(elem_alias, elem_alias.contains("S")) && !fs.exists(elem_alias, elem_alias.contains("S")) && fs.filter(elem_alias, elem_alias.contains("S")).size() >= 2 && fs.filter(elem_alias, elem_alias.fv.contains("S")).size() >= 2 && double(fs.filter(elem_alias, elem_alias.contains("S")).size()) >= (double(fs.size()) * 0.5) && fs.filter(elem_alias, elem_alias.contains("S")).size() <= 2 && double(fs.filter(elem_alias, elem_alias.contains("S")).size()) <= (double(fs.size()) * 0.5) && fs.filter(elem_alias, elem_alias.contains("S")).size() == 2 && double(fs.filter(elem_alias, elem_alias.contains("S")).size()) == (double(fs.size()) * 0.5) && fs.all(elem_alias, elem_alias.contains("S") && elem_alias.contains("S")) && fs.filter(elem_alias, elem_alias.contains("S") && elem_alias.contains("S")).size() >= 2';
