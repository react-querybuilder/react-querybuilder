...
import { dndFallback, useControlledOrUncontrolled } from './internal/hooks';
import type {
  Classnames,
  Controls,
  Field,
...
export const QueryBuilderBase = <RG extends RuleGroupType | RuleGroupTypeIC>({
  defaultQuery,
  query: queryProp,
  ...
  const schemaDnd = useMemo(
    () => ({ ...dndFallback, hooks: { ...dndFallback.hooks, ...dnd } }),
    [dnd]
  );
...
QueryBuilderBase.displayName = 'QueryBuilderBase';
