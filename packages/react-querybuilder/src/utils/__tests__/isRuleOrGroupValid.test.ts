...
describe('isRuleOrGroupValid', () => {
  ...
  describe('object validationResult', () => {
    it('should validate a rule with validationResult.valid = true', () => {
      expect(
        isRuleOrGroupValid({ field: 'field', operator: '=', value: '' }, { valid: true })
      ).toBe(true);
    });
    ...
    it('should invalidate a rule with validationResult.valid = false', () => {
      expect(
        isRuleOrGroupValid({ field: 'field', operator: '=', value: '' }, { valid: false })
      ).toBe(false);
    });
  ...
  describe('validator function - groups', () => {
    it('should validate a group with validator function', () => {
      expect(isRuleOrGroupValid({ combinator: 'and', rules: [] }, undefined, () => false)).toBe(
        true
      );
    });
