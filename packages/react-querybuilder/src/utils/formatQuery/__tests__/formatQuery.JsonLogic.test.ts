...
it('handles match modes', () => {
  const queryWithMatchModes: RuleGroupType = {
    combinator: 'and',
    rules: [
      { field: 'fs', operator: 'contains', value: 'S', matchMode: { mode: 'all' } },
      { field: 'fs', operator: 'contains', value: 'S', matchMode: { mode: 'none' } },
      { field: 'fs', operator: 'contains', value: 'S', matchMode: { mode: 'some' } },
      {
        field: 'fs',
        operator: 'contains',
        value: 'S',
      ...
      },
      {
        ...
        operator: 'contains',
        value: 'S',
        matchMode: { mode: 'exactly', threshold: -1 },
      },
      {
        field: 'fs',
        operator: 'contains',
      ...
      /* eslint-disable @typescript-eslint/no-explicit-any */
      {
        ...
        operator: 'contains',
        value: 'S',
        matchMode: { mode: 'exactly', threshold: '-1' as any },
      },
      { field: 'fs', operator: 'contains', value: 'S', matchMode: { mode: 'atMost' as any } },
      { field: 'fs', operator: 'contains', value: 'S', matchMode: { mode: 'atLeast' as any } },
      { field: 'fs', operator: 'contains', value: 'S', matchMode: { mode: 'exactly' as any } },
