...
export default defineConfig(options => {
  ...
  const opts: Options[] = [
    ...
    // ESM, Webpack 4 support. Target ES2017 syntax to compile away optional chaining and spreads
    {
      ...commonOptions,
      entry: {
        'react-querybuilder_antd.legacy-esm': 'src/index.tsx',
      },
    ...
    // ESM for use in browsers. Minified, with `process` compiled away
    {
      ...
      ...productionOptions,
      entry: {
        'react-querybuilder_antd.production': 'src/index.tsx',
      },
      format: ['esm'],
      outExtension: () => ({ js: '.mjs' }),
    },
    // CJS development
    {
      ...commonOptions,
      entry: {
        'react-querybuilder_antd.cjs.development': 'src/index.tsx',
      },
      format: 'cjs',
      outDir: './dist/cjs/',
    },
    // CJS production
    {
      ...
      ...productionOptions,
      entry: {
        'react-querybuilder_antd.cjs.production': 'src/index.tsx',
      },
      format: 'cjs',
      outDir: './dist/cjs/',
      onSuccess: async () => {
