...
export const configs: Record<string, ExampleConfig> = {
  ...
  datetime: {
    name: 'Date/Time',
    dependencyKeys: [],
    cssPre: [`@import '@react-querybuilder/datetime/dist/datetime.css';`],
    cssPost: [],
    tsxImports: [`import { QueryBuilderDateTime } from '@react-querybuilder/datetime/ui';`],
    additionalDeclarations: [],
    wrapper: [`<QueryBuilderDateTime>`, `</QueryBuilderDateTime>`],
    props: [],
    compileToJS: false,
