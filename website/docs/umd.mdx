...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://unpkg.com/react-querybuilder@next/dist/query-builder.css" />
  </head>
  <body>
    <div id="root"></div>
    <script>
    ...
    <script
      crossorigin
      src="https://unpkg.com/@react-querybuilder/ctx@next/dist/index.umd.js"></script>
    <script crossorigin src="https://unpkg.com/react-querybuilder@next/dist/index.umd.js"></script>
...
<html lang="en">
  ...
  <body>
    ...
    <script
      crossorigin
      src="https://unpkg.com/@react-querybuilder/dnd@next/dist/index.umd.js"></script>
    <!-- highlight-end -->
    <script crossorigin src="https://unpkg.com/babel-standalone@6/babel.min.js"></script>
    <script type="text/babel">
      const fields = [
