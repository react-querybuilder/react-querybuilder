...
`boolean` (default `false`) [_Click for demo_](/react-querybuilder#showCombinatorsBetweenRules=true)
...
`boolean` (default `false`) [_Click for demo_](/react-querybuilder#showNotToggle=true)

Pass `true` to show the "Not" (aka inversion) toggle switch for each rule group.

### `showCloneButtons`

`boolean` (default `false`) [_Click for demo_](/react-querybuilder#showCloneButtons=true)

### `showLockButtons`

`boolean` (default `false`) [_Click for demo_](/react-querybuilder#showLockButtons=true)
...
`boolean` (default `true`) [_Click for demo with this feature disabled_](/react-querybuilder#resetOnFieldChange=false)

Pass `false` to avoid resetting the operator and value when the field changes.

### `resetOnOperatorChange`

`boolean` (default `false`) [_Click for demo_](/react-querybuilder#resetOnOperatorChange=true)
...
`boolean` (default `true`) [_Click for demo with this feature disabled_](/react-querybuilder#autoSelectField=false)
...
`boolean` (default `true`) [_Click for demo with this feature disabled_](/react-querybuilder#autoSelectOperator=false)
...
`boolean` (default `false`) [_Click for demo_](/react-querybuilder#addRuleToNewGroups=true)
...
`boolean` (default `false`) [_Click for demo_](/react-querybuilder#listsAsArrays=true)
...
`boolean` (default `false`) [_Click for demo_](/react-querybuilder#independentCombinators=true)
...
`boolean` (default `false`) [_Click for demo_](/react-querybuilder#enableDragAndDrop=true)
...
`boolean | number[][]` (default `false`) [_Click for demo_](/react-querybuilder#disabled=true)
...
`boolean` (default `false`) [_Click for demo_](/react-querybuilder#debugMode=true)
...
`QueryValidator` [_Click for demo_](/react-querybuilder#validateQuery=true)
