...
As of v6.2.0, MUI components will be loaded synchronously. Preloading the components is no longer necessary and there will be no flash of unstyled content.
