...
| [Blueprint](https://blueprintjs.com/)               | [@react-querybuilder/blueprint](https://www.npmjs.com/package/@react-querybuilder/blueprint) | [Demo](/demo/blueprint) | [CodeSandbox](https://codesandbox.io/s/github/react-querybuilder/react-querybuilder/tree/main/examples/blueprint?file=/src/App.tsx) | [StackBlitz](https://stackblitz.com/github/react-querybuilder/react-querybuilder/tree/main/examples/blueprint?file=src/App.tsx) |
...
| `BlueprintActionElement`            | `ActionWithRulesProps`   | `import { Button } from '@blueprintjs/core'`                            |
| `BlueprintNotToggle`                | `NotToggleProps`         | `import { Switch } from '@blueprintjs/core'`                            |
| `BlueprintValueSelector`            | `VersatileSelectorProps` | `import { MultiSelect } from '@blueprintjs/select'` (multi-select only) |
