...
To discover all the options of React Query Builder, check out the [API documentation](./api/querybuilder). To play around with various configurations, including other export formats and [importing from SQL](./api/import), check out the [demo](https://react-querybuilder.js.org/react-querybuilder).
