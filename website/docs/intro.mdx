...
- [Basic example (TypeScript)](https://codesandbox.io/s/github/react-querybuilder/react-querybuilder/tree/main/examples/basic-ts)
- [Basic example (JavaScript)](https://codesandbox.io/s/github/react-querybuilder/react-querybuilder/tree/main/examples/basic)
- [More examples](https://github.com/react-querybuilder/react-querybuilder/tree/main/examples/)

## Installation

To install `react-querybuilder`, use [npm](https://www.npmjs.com/package/react-querybuilder) or [Yarn](https://yarnpkg.com/package/react-querybuilder), or follow [these instructions for a buildless environment](./buildless).
...
To convert a query object into other formats like [SQL](https://en.wikipedia.org/wiki/SQL), [MongoDB](https://www.mongodb.com/), and [CEL](https://github.com/google/cel-spec), you can use the `formatQuery` function ([full documentation here](./utils/export)). The example below demonstrates the conversion of a query to its equivalent SQL form. Modify the query by manipulating the form elements and the SQL will update accordingly.
...
To discover all the options of React Query Builder, check out the [API documentation](./components/querybuilder). To play around with various configurations, including other export formats and [importing from SQL](./utils/import), check out the [demo](/demo).
