...
[^3]: Only rendered if neither [`showCombinatorsBetweenRules`](./querybuilder#showcombinatorsbetweenrules) nor [`independentCombinators`](./querybuilder#independentcombinators) are `true`.
