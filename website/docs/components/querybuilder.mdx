...
Default is [`ShiftActions`](./shiftactions). Receives the following props per the `ShiftActionsProps` interface:
...
| `path`        | `Path`                                          | [Path](../tips/path) of this rule/group                                                                       |
| `schema`      | `Schema`                                        | Query [schema](../typescript#miscellaneous)                                                                   |
| `lastInGroup` | `boolean`                                       | Whether this rule/group is the last of its siblings                                                           |
