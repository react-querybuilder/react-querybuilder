...
| `MantineActionElement`  | `ActionWithRulesProps`   | `import Button from '@mui/material/Button'`                     |
| `MantineNotToggle`      | `NotToggleProps`         | `import Switch from '@mui/material/Switch'`                     |
| `MantineValueSelector`  | `VersatileSelectorProps` | `import Select from '@mui/material/Select'`                     |
