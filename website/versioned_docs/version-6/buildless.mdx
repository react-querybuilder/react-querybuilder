...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/react-querybuilder@6.0.7/dist/query-builder.css" />
  </head>
  <body>
    <div id="root"></div>
    <script type="module">
      ...
      import { QueryBuilder } from 'https://cdn.jsdelivr.net/npm/react-querybuilder@6.0.7/+esm';
...
<html lang="en">
  ...
  <body>
    ...
    <script type="module">
      ...
      import { QueryBuilderDnD } from 'https://cdn.jsdelivr.net/npm/@react-querybuilder/dnd@6.0.7/+esm';
      // highlight-end
      // Make the imports available to the Babel script below
      window.React = React;
      window.ReactDOM = ReactDOM;
