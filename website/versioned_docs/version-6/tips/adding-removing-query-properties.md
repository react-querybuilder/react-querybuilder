...
To produce a query object with additional properties, you can loop through the `rules` array recursively. The [`transformQuery`](../utils/misc#transformquery) function is provided for use cases such as this.
