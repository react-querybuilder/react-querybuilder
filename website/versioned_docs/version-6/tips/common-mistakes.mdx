...
When defining custom components for React Query Builder, [do not define them within the body of another function component](https://beta.reactjs.org/learn/your-first-component#nesting-and-organizing-components) like this:
