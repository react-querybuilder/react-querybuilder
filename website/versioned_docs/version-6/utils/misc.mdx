...
- [`InlineCombinator`](../components/rulegroup) - used when either [`showCombinatorsBetweenRules`](../components/querybuilder#showcombinatorsbetweenrules) or [`independentCombinators`](../components/querybuilder#independentcombinators) are `true`
