...
For more information about option list props like `operators`, see [Working with option lists](./option-lists).
...
For more information about option list props like `combinators`, see [Working with option lists](./option-lists).
