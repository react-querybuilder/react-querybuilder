...
To install `react-querybuilder`, use a package manager like [npm](https://www.npmjs.com/), [Yarn](https://yarnpkg.com/), [pnpm](https://pnpm.io/), or [Bun](https://bun.sh/). A [UMD build](./umd) is also available.
