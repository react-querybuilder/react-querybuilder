...
- [#1078] Query tools accept opt-in guard options that block a mutation before it is attempted, reported through `onAbort` with the new reasons `"target-disabled"`, `"parent-disabled"`, and `"max-levels-exceeded"`:
