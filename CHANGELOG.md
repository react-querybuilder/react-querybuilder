...
- [#820] New "mongodb_query" export format. This format is exactly the same as "mongodb" except that it returns an actual JSON object instead of a `JSON.stringify`d version. The "mongodb" format is deprecated but will not be removed.
